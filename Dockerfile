...
ADD ./hybris-commerce-suite-5.4.0.4.zip /tmp/
...
ENV HYB-JAVA-XMX=2g HYB-JAVA-XMS=2g HYB-JAVA-PERM=1024m HYB-JAVA-MAXPERM=1024m HYB-JAVA-GCLOGPTH=/opt/hybris/current/hybris/log/tomcat/hybris-gc.log HYB-JAVA-NUMGCLOGS=5 HYB-JAVA-MAXGCLOGSZ=100M HYB-APM-JAVAAGENT="" 
